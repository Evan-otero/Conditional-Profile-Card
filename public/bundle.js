...
function render(variables = {}) {
  ...
  if (variables.nam == null) n = `<div class 'name'>Your name </div>`;else n = `<div class 'name'>"${variables.nam}"</div>`;

  let l = `<div class= "lastname">${variables.las}</div>`;
  if (variables.las == null) l = `<div class 'lastname'> Your last name</div>`;else n = `<div class 'lastname'>"${variables.las}"</div>`;
